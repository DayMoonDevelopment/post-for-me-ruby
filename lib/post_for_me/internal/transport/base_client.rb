  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => PostForMe::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => PostForMe::Internal::Util.os,
            "x-stainless-package-version" => PostForMe::VERSION,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = PostForMe::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise PostForMe::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if PostForMe::Internal::Util.uri_origin(url) != PostForMe::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, PostForMe::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in PostForMe::Errors::APIConnectionError | (500..)
              PostForMe::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        # @api private
        # @return [PostForMe::Internal::Transport::PooledNetRequester]
        ...
        def initialize(
          ...
          @requester = PostForMe::Internal::Transport::PooledNetRequester.new
          @headers = PostForMe::Internal::Util.normalized_headers(
          ...
          @base_url_components = PostForMe::Internal::Util.parse_uri(base_url)
          @base_url = PostForMe::Internal::Util.unparse_uri(@base_url_components)
        ...
        #
        #   @option req [Class<PostForMe::Internal::Type::BasePage>, nil] :page
        #
        #   @option req [Class<PostForMe::Internal::Type::BaseStream>, nil] :stream
        #
        #   @option req [PostForMe::Internal::Type::Converter, Class, nil] :model
        #
        ...
        private def build_request(req, opts)
          ...
          path = PostForMe::Internal::Util.interpolate_path(uninterpolated_path)

          query = PostForMe::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          headers, encoded = PostForMe::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        private def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          input = {**request.except(:timeout), deadline: PostForMe::Internal::Util.monotonic_secs + timeout}
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise PostForMe::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
          ...
          in (400..) | PostForMe::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        # methods call into.
        #
        # @overload request(method, path, query: {}, headers: {}, body: nil, unwrap: nil, page: nil, stream: nil, model: PostForMe::Internal::Type::Unknown, options: {})
        #
        # @param method [Symbol]
        #
        ...
        #
        # @param page [Class<PostForMe::Internal::Type::BasePage>, nil]
        #
        # @param stream [Class<PostForMe::Internal::Type::BaseStream>, nil]
        #
        # @param model [PostForMe::Internal::Type::Converter, Class, nil]
        #
        # @param options [PostForMe::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { PostForMe::Internal::Type::Unknown }
          opts = req[:options].to_h
          unwrap = req[:unwrap]
          PostForMe::RequestOptions.validate!(opts)
          ...
          T.type_alias do
            {
              ...
              page: T.nilable(T::Class[PostForMe::Internal::Type::BasePage[PostForMe::Internal::Type::BaseModel]]),
              stream: T.nilable(T::Class[T.anything]),
              model: T.nilable(PostForMe::Internal::Type::Converter::Input),
              options: T.nilable(PostForMe::RequestOptions::OrHash)
            }
          end
        end
