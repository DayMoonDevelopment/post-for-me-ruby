      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - PostForMe::Internal::Util.monotonic_secs
          ...
          def build_request(request, &blk)
            ...
            in String
              ...
              req.body_stream = PostForMe::Internal::Util::ReadIOAdapter.new(body, &blk)
            in StringIO
        ...
        private def with_pool(url, deadline:, &blk)
          origin = PostForMe::Internal::Util.uri_origin(url)
          timeout = deadline - PostForMe::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise PostForMe::Errors::APIConnectionError.new(url: url, request: req)
          end
