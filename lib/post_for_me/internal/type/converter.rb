    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { PostForMe::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { PostForMe::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            PostForMe::FilePart.new(value)
          in PostForMe::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in PostForMe::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [PostForMe::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: PostForMe::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in PostForMe::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in PostForMe::Internal::Type::Converter
              ...
              PostForMe::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(PostForMe::Internal::Type::Converter, T::Class[T.anything]) }
        end
