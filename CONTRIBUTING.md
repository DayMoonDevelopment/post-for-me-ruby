...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/post_for_me/helpers/` and `examples/` directory.
...
require_relative "../lib/post_for_me"
...
```ruby
gem "post-for-me", git: "https://www.github.com/DayMoonDevelopment/post-for-me-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/DayMoonDevelopment/post-for-me-ruby' '<path-to-repo>'
```

```ruby
gem "post-for-me", path: "<path-to-repo>"
```
