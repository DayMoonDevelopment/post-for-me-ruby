...
class PostForMe::Test::PrimitiveModelTest < Minitest::Test
  A = PostForMe::Internal::Type::ArrayOf[-> { Integer }]
  H = PostForMe::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < PostForMe::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      PostForMe::Internal::Type::Unknown,
      PostForMe::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => PostForMe::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [PostForMe::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [PostForMe::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [PostForMe::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = PostForMe::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        PostForMe::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [PostForMe::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [PostForMe::Internal::Type::Boolean, true] => true,
      [PostForMe::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => PostForMe::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        PostForMe::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = PostForMe::Internal::Type::Converter.new_coerce_state
      PostForMe::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        PostForMe::Internal::Type::Converter.dump(target, input, state: state)
...
class PostForMe::Test::EnumModelTest < Minitest::Test
  class E0
    include PostForMe::Internal::Type::Enum
...
class PostForMe::Test::CollectionModelTest < Minitest::Test
  A1 = PostForMe::Internal::Type::ArrayOf[-> { Integer }]
  H1 = PostForMe::Internal::Type::HashOf[Integer]

  A2 = PostForMe::Internal::Type::ArrayOf[H1]
  H2 = PostForMe::Internal::Type::HashOf[-> { A1 }]

  A3 = PostForMe::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = PostForMe::Internal::Type::HashOf[Integer, nil?: true]
...
class PostForMe::Test::BaseModelTest < Minitest::Test
  class M1 < PostForMe::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < PostForMe::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < PostForMe::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, PostForMe::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = PostForMe::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = PostForMe::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(PostForMe::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue PostForMe::Errors::ConversionError => e
...
class PostForMe::Test::UnionTest < Minitest::Test
  class U0
    include PostForMe::Internal::Type::Union
  ...
  class M2 < PostForMe::Internal::Type::BaseModel
  ...
  class M4 < PostForMe::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, PostForMe::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < PostForMe::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, PostForMe::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class PostForMe::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include PostForMe::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [PostForMe::Internal::Type::Unknown, PostForMe::Internal::Type::Unknown] => true,
      [PostForMe::Internal::Type::Boolean, PostForMe::Internal::Type::Boolean] => true,
      [PostForMe::Internal::Type::Unknown, PostForMe::Internal::Type::Boolean] => false,
...
class PostForMe::Test::MetaInfoTest < Minitest::Test
  A1 = PostForMe::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = PostForMe::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
