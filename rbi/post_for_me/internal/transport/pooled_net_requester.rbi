      ...
      class PooledNetRequester
        ...
        class << self
          ...
          sig do
            params(
              request:
                PostForMe::Internal::Transport::PooledNetRequester::Request,
        ...
        sig do
          params(
            request: PostForMe::Internal::Transport::PooledNetRequester::Request
        ...
        def self.new(
          size: PostForMe::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS
        )
        end
      end
    end
