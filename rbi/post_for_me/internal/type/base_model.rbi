    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  PostForMe::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(
                        PostForMe::Internal::Type::Converter::Input
                      )
                  }
                )
              ]
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  PostForMe::Internal::Type::BaseModel::KnownField,
                  { type: PostForMe::Internal::Type::Converter::Input }
                )
              ]
            )
          end
          ...
          sig do
            params(
              ...
              spec: PostForMe::Internal::AnyHash
            ).void
          end
          ...
          sig do
            override
              .params(
                ...
                state: PostForMe::Internal::Type::Converter::CoerceState
              )
          ...
          sig do
            override
              .params(
                ...
                state: PostForMe::Internal::Type::Converter::DumpState
              )
        ...
        class << self
          ...
          sig do
            params(
              model: PostForMe::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(PostForMe::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(PostForMe::Internal::AnyHash) }
        def to_h
        end
